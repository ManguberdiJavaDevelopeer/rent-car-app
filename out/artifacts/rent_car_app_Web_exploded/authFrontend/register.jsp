...
<div class="container-fluid">
    <div class="row">
        <div class="col-6 offset-3 text-center bg-light">
            ...
            <br>
            <% }%>
            <form action="${pageContext.request.contextPath}/register" class="was-validated" method="post">
                ...
                <div class="mb-3 mt-3 text-start">
                    ...
                    <input type="text" class="form-control" id="email" placeholder="Enter email or username" name="email" required>
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">Please fill out this field.</div>
                </div>
                ...
                <div class="mb-3 text-start">
                    ...
                    <input type="password" class="form-control" id="conPassword" placeholder="Confirm password" name="conPassword" required>
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">Please fill out this field.</div>
                </div>
